...
namespace AlgorithmsVizualizator.AStarAlgorithm
{
    public class AStarAlgorithmClass
    {
        public List<Point> FindPath(int[,] field, Point start, Point goal)
        {
            ...
            PathNode startNode = new PathNode()
            {
                ...
                EstimatePathLength = GetHeuristicPathLength(start, goal)
            };
        ...
        private List<PathNode> GetNeighbours(PathNode pathNode,  Point goal, int[,] field)
        {
            ...
            foreach (var point in neighbourPoints)
            {
                ...
                var neighbourNode = new PathNode()
                {
                    ...
                    EstimatePathLength = GetHeuristicPathLength(point, goal)
                };
